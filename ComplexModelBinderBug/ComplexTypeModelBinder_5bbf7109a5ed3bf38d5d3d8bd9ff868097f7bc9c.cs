...
/// <summary>
/// https://github.com/aspnet/AspNetCore/blob/5bbf7109a5ed3bf38d5d3d8bd9ff868097f7bc9c/src/Mvc/src/Microsoft.AspNetCore.Mvc.Core/ModelBinding/Binders/ComplexTypeModelBinder.cs
/// </summary>
namespace ComplexModelBinderBug.Binders
{
    ...
    public class ComplexTypeModelBinder : IModelBinder
    {
        ...
        public Task BindModelAsync(ModelBindingContext bindingContext)
        {
            ...
            _logger.LogDebug("AttemptingToBindModel {bindingContext}", bindingContext);
        ...
        private async Task BindModelCoreAsync(ModelBindingContext bindingContext, int propertyData)
        {
            ...
            _logger.LogDebug("DoneAttemptingToBindModel {bindingContext}", bindingContext);
        ...
        private int CanBindAnyModelProperties(ModelBindingContext bindingContext)
        {
            ...
            if (bindingContext.ModelMetadata.Properties.Count == 0)
            {
                ...
                _logger.LogDebug("NoPublicSettableProperties {bindingContext}", bindingContext);
            ...
            _logger.LogDebug("CannotBindToComplexType {bindingContext}", bindingContext);
        ...
        protected virtual object CreateModel(ModelBindingContext bindingContext)
        {
            ...
            if (_modelCreator == null)
            {
                ...
                if (modelTypeInfo.IsAbstract || modelTypeInfo.GetConstructor(Type.EmptyTypes) == null)
                {
                    ...
                    {
                        case ModelMetadataKind.Parameter:
                            throw new InvalidOperationException($"FormatComplexTypeModelBinder_NoParameterlessConstructor_ForParameter => {modelTypeInfo.FullName}/{metadata.ParameterName}");
                        case ModelMetadataKind.Property:
                            throw new InvalidOperationException($"FormatComplexTypeModelBinder_NoParameterlessConstructor_ForProperty => {modelTypeInfo.FullName}/{metadata.PropertyName}/{bindingContext.ModelMetadata.ContainerType.FullName}");
                        case ModelMetadataKind.Type:
                            throw new InvalidOperationException($"FormatComplexTypeModelBinder_NoParameterlessConstructor_ForType => {modelTypeInfo.FullName}");
                    }
                }
