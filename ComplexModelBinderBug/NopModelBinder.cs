...
namespace ComplexModelBinderBug
{
    ...
    public class NopModelBinder : ComplexTypeModelBinder
    {
        ...
        protected override object CreateModel(ModelBindingContext bindingContext)
        {
            ...
            if (model is Models.BaseNopModel)
                (model as Models.BaseNopModel).BindModel(bindingContext);
            ...
            ModelMetadata propertyMetadata, ModelBindingResult bindingResult)
        {
            ...
            if (bindingContext.Model is Models.BaseNopModel && !string.IsNullOrEmpty(valueAsString))
            {
